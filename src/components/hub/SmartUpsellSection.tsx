...
function UpsellCard({
  ...
  return (
    <div className="relative bg-[#0F172A] rounded-xl p-8 md:p-12 overflow-hidden shadow-2xl shadow-indigo-900/20 group">
      {/* Decorative */}
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 text-center hover:bg-white/10 transition-colors">
            ...
            <button
              onClick={onBuy}
              className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-lg shadow-lg shadow-indigo-600/20 transition-all hover:scale-105 active:scale-95 mb-4 flex items-center justify-center gap-2"
            >
