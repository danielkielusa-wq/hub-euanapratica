...
import { Calendar, FileText, Clock, Video, ChevronRight } from 'lucide-react';
...
export function OverviewContent({
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      {/* Upcoming Sessions */}
      <Card variant="glass" className="animate-fade-slide-up" style={{ animationDelay: '200ms' }}>
            ...
            upcomingSessions.slice(0, 3).map((session, idx) => (
              ...
              >
                ...
                {session.meeting_link && (
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-lg ml-2 h-8 px-3"
                    asChild
                  >
      ...
      {/* Pending Assignments */}
      <Card variant="glass" className="animate-fade-slide-up" style={{ animationDelay: '250ms' }}>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-semibold flex items-center gap-2">
            ...
            pendingAssignments.slice(0, 3).map((assignment) => (
              ...
              >
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="rounded-lg ml-2 h-8 px-3"
                >
                  Entregar
                </Button>
              </div>
