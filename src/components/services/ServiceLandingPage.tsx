             ...
             {mentor && (
               <div className="hidden md:block w-80 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-6 text-center transform rotate-3 hover:rotate-0 transition-all duration-500">
                   <div className="w-24 h-24 mx-auto bg-gray-200 rounded-full mb-4 border-4 border-white/10 overflow-hidden">
                      <div className="w-full h-full bg-brand-900 flex items-center justify-center text-2xl font-black text-white">
                        {mentor.initials}
                      </div>
                   </div>
                   <h3 className="text-xl font-bold text-white mb-1">{mentor.name}</h3>
                   <p className="text-brand-200 text-xs font-bold uppercase tracking-widest mb-6">{mentor.title}</p>
                   {mentor.quote && (
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-10 relative z-20">
         ...
         {faqSection && (
           <div className="bg-brand-50 rounded-[32px] p-8 md:p-12 text-center border border-brand-100 mb-10">
               ...
               <h3 className="text-2xl font-black text-brand-900 mb-4">{faqSection.title}</h3>
               <p className="text-brand-800 text-sm max-w-2xl mx-auto leading-relaxed"
         ...
         <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
            ...
            <div className="flex-1 md:flex-none flex gap-4 w-full md:w-auto">
               ...
               <button
                 ...
                 className="flex-1 md:w-auto px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white font-black rounded-2xl shadow-xl shadow-brand-600/20 transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
               >
                  <Calendar size={20} />
