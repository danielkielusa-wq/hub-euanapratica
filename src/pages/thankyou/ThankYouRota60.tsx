        ...
        <div className="relative z-10 px-8 py-16 md:p-20 text-center">
          ...
          <div className="max-w-xl mx-auto bg-muted/50 border border-border rounded-3xl p-8 mb-12 text-left">
            <div className="flex items-start gap-5">
              ...
              <div>
                <h3 className="font-black text-foreground text-lg">Sessão de Direção ROTA EUA™</h3>
                <p className="text-sm text-muted-foreground">Duração: 60 minutos individuais</p>
