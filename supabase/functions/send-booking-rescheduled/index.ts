...
Deno.serve(async (req) => {
  ...
  try {
    ...
    dispatchN8NWebhook("booking.rescheduled", {
      booking_id,
      ...
      old_scheduled_start: old_datetime ?? null,
      new_scheduled_start: booking.scheduled_start,
      new_scheduled_end: booking.scheduled_end,
    }, supabase);
