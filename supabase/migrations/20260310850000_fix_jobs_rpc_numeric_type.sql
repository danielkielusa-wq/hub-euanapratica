-- Fix: salary_min/salary_max columns in jobs table are NUMERIC, not BIGINT.
-- The previous migration (20260310800000) changed from INTEGER to BIGINT but
-- the actual column type is NUMERIC, causing "structure of query does not match
-- function result type" errors.

-- 1. get_jobs_with_user_context
