-- ============================================================================
-- Increase footer logo and handle size across all 4 templates
-- Logo: 28px → 40px, Handle: 16px → 22px
-- ============================================================================
...
.handle { font-size: 22px; font-weight: 500; color: #475569; }
/* Cover variant */
...
.brand-logo { height: 40px; display: block; }
.handle { font-size: 22px; font-weight: 500; color: #94a3b8; }
/* Cover */
...
.brand-logo { height: 40px; display: block; }
.handle { font-size: 22px; font-weight: 500; color: rgba(255,255,255,0.5); }
/* Cover */
...
.brand-logo { height: 40px; display: block; }
.handle { font-size: 22px; font-weight: 500; color: rgba(199,210,254,0.4); }
/* Cover variant */
.slide-cover .headline { font-size: 68px; text-align: center; }
