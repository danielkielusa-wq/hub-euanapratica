-- ============================================================================
-- Fix all carousel templates: larger fonts, better space utilization
--
-- Problems: headline 44px too small for 1080x1080, body 24px hard to read,
-- justify-content:center leaves too much empty space above/below content.
-- Fix: increase all font sizes, use flex-start + padding-top for main.
-- ============================================================================
...
.brand { font-size: 16px; font-weight: 800; color: #f97316; letter-spacing: 3px; text-transform: uppercase; }
...
.brand { font-size: 16px; font-weight: 800; color: #2563eb; letter-spacing: 3px; text-transform: uppercase; }
...
.brand { font-size: 16px; font-weight: 800; color: #ffffff; letter-spacing: 3px; text-transform: uppercase; }
...
.brand { font-size: 16px; font-weight: 800; color: #a5b4fc; letter-spacing: 3px; text-transform: uppercase; }
