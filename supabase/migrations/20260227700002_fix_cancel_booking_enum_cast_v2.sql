-- =============================================================
-- Fix v2: Restore v_new_status as booking_status (not TEXT)
-- and cast CASE result to booking_action for history INSERT.
-- =============================================================
...
DECLARE
    v_booking RECORD;
    v_policy RECORD;
    v_new_status booking_status;  -- must be enum, not TEXT
BEGIN
    -- Get booking
    ...
    -- Record history (CASE returns text, must cast to booking_action enum)
