-- ============================================================================
-- Fix logo in templates: use white logo PNG for dark templates, dark logo for light
-- Removes CSS filter hack, uses proper white-on-transparent logo file instead.
-- ============================================================================

-- Dark Professional — use white logo
...
SET
  ...
  <div class="footer">
    <div class="brand"><img src="{{logoWhiteSrc}}" class="brand-logo" alt="" /></div>
...
SET
  ...
  <div class="footer">
    <div class="brand"><img src="{{logoDarkSrc}}" class="brand-logo" alt="" /></div>
    <div class="handle">@eua_na_pratica</div>
  </div>
...
-- Indigo Gradient — use white logo
UPDATE public.content_visual_templates
SET
  html_template = '<div class="slide slide-{{slideType}}">
